...
<head>
    ...
    <meta name="description" content="TrackBridge — Create your account">
    <title>Create Account &middot; TrackBridge</title>
        ...
        <aside class="auth-aside">
            <div class="auth-aside-inner">
                ...
                <ul class="auth-aside-features">
                    ...
                    <li><i class="fas fa-check-circle"></i> Operator — digitize and submit for QC</li>
                    ...
                    <div class="auth-card-body">
                        ...
                        <?= $this->Form->create($user ?? null, ['class' => 'auth-form']) ?>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <div class="auth-field mb-0">
                                        <label class="auth-label" for="password_confirm">Confirm</label>
                                        <div class="input-group auth-input-group">
