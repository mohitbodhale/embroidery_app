...
class JobStatusesFixture extends TestFixture
{
    public function init(): void
    {
        $this->records = [
            ...
            ['id' => 2, 'name' => 'in_digitizing',   'label' => 'In Digitizing',   'description' => null, 'color' => '#0d6efd', 'sort_order' => 20, 'is_active' => true, 'is_terminal' => false, 'created_at' => '2025-01-01 00:00:00'],
            ['id' => 3, 'name' => 'digitized',       'label' => 'Digitized',       'description' => null, 'color' => '#6610f2', 'sort_order' => 30, 'is_active' => true, 'is_terminal' => false, 'created_at' => '2025-01-01 00:00:00'],
